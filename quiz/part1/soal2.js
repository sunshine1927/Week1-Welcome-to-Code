...
let namaBulan; // buat variabel baru untuk penggabungan bulan dalam bentuk integer (1 - 12) dan string (jan - des)

// Menggunakan switch untuk menentukan nama bulan berdasarkan nilai variabel bulan
switch (bulan) {
    case 1:
        namaBulan = "Januari";
        break;
...
let tanggalFormat = `${tanggal} ${namaBulan} ${tahun}`;
